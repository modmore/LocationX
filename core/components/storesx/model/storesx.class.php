...
class StoresX {
    ...
    /**
     * Main StoresX constructor for setting up configuration etc.
     *
     * @param \modX $modx
     * @param array $config
     * @return \StoresX
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $basePath = $this->modx->getOption('storesx.core_path',$config,$this->modx->getOption('core_path').'components/storesx/');
        $assetsUrl = $this->modx->getOption('storesx.assets_url',$config,$this->modx->getOption('assets_url').'components/storesx/');
        $assetsPath = $this->modx->getOption('storesx.assets_path',$config,$this->modx->getOption('assets_path').'components/storesx/');
        ...
        $this->modx->lexicon->load('storesx:default');
    }
